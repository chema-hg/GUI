...
# Calcula el coste del viaje con validacion y calculo posterior

class Aplicacion():
    def __init__(self):
        self.raiz=Tk()
        self.raiz.title("Autobuses SL.")
        ...
        self.precio = DoubleVar(value=0.20)
        self.total = DoubleVar(value=0.0)
        
        # Carga imagen para asociar a widget label()
        # En tkinter algunos widgets pueden mostrar imagenes como label o button.
        # Estos widgets toman una imagen como argumento. Sin embargo no se puede pasar directamente
        # la imagen como argumento. Se necesita pasar un objeto PhotoImage.
        ...
        self.clase1 = ttk.Radiobutton(self.raiz, text='Normal', variable=self.clase, value='t')
        self.clase2 = ttk.Radiobutton(self.raiz, text='Supra', variable=self.clase, value='p')
        self.clase3 = ttk.Radiobutton(self.raiz, text='Gran Lujo', variable=self.clase, value='1')
    ...
    def calcular(self):
        ...
        # Funcion para validar los datos y calcular el importe
        # a pagar.
