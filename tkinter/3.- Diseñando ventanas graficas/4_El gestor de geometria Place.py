...
class Aplicacion():
    def __init__(self):
        ...
        # bordermoder
        # outside counts x and y from the top left corner of the frame including the border,
        # while inside counts it without the border.
        self.boton1.place(x=170, y=160)
        self.boton2.place(x=290, y=160)
        self.ctext2.focus_set()
        
        # El metodo 'bind()' asocia el evento de 'hacer clic
        ...
        # <key-space>, <key-print>, <keypress-h>, etc. (Creo que hay que ponerlo en mayusculas la letra inicial)
